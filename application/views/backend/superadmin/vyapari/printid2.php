...
<body>
    ...
    <div style="position:absolute; left:-93px; top:178px; transform: rotate(90deg);">
        <div>
      <img width="350px" height="30px" src="<?php echo base_url('uploads/heading_images_bg.png'); ?>" style="position:relative;     left: -84px;
    top: -4px;">
      </div>
       <div class="vyapari_coluom_one">
            <?php if (!empty($vyapari['photo'])): ?>
                <img width="146px" height="116px" src="<?= base_url('uploads/vyapari_photo/' . $vyapari['photo']) ?>?<?php echo time() ?>">
            <?php endif; ?>
       </div> 
