           ...
           <div role="tabpanel" class="tab-pane  in active" id="manualentery">
              ...
              <form method="POST" class="d-block ajaxForm" action="<?php echo route('manage_vyapari/bulk_insert_qrcode/'.$vyapari_id); ?>">
                 <div class="form-row">
                    ...
                    <div class="form-group col-md-6">
                        <label style="margin: 0;" for="broker_id">Beef Helkari</label>
                       <select name="broker_id" class="form-control select2" required>
                           ...
                           <option value="">Select Helkari</option>
                           <?php foreach($app_broker as $row): ?>
                           <option value="<?= $row['id']; ?>" <?php if($row['id'] == 24){ echo 'selected'; } ?>><?= $row['applicant_name']; ?></option>
                           <?php endforeach; ?>
                       </select>
                    </div>
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <div class="">
                            <div class="form-check">
                              <input class="form-check-input" type="radio" name="slaughtering_type" id="slaughtering_type1" value="1" >
                              <label class="form-check-label form-label" for="slaughtering_type1">
                                For Slaughtering
                              </label>
                            </div>
                            <div class="form-check">
                              <input class="form-check-input" type="radio" name="slaughtering_type" id="slaughtering_type2" value="2" checked>
