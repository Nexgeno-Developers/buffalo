<?php if(!access('manage_butcher')){ redirect(route('dashboard')); } ?>
        ...
        <div class="card mt-2">
            ...
            <div class="row mb-1">
                    ...
                    <div class="col-md-2 col-6 mb-1">
                        ...
                        <input type="text" name="phone" class="form-control" placeholder="butcher Phone">
                    </div>    
                    <div class="col-md-2 col-6 mb-1">
                ...
                <div class="butcher_content block-rep1">
...
<script>
    var showAllbutcher = function () {
        var url = '<?php echo route('manage_butcher/list'); ?>';
