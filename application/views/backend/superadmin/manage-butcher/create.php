...
<form id="vyapari_create" method="POST" class="d-block ajaxForm" enctype="multipart/form-data" action="<?php echo route('manage_butcher/create'); ?>">
    <div class="form-row">
...
<script language="JavaScript">
    ...
    function submit_webcam_image()
    {
        ...
        $.ajax
        ({ 
            url: '<?php echo base_url('superadmin/manage_butcher/UploadWebCamImage'); ?>',
