  ...
  <ul class="metismenu side-nav side-nav-light">
    ...
    <li class="side-nav-item sub_menu">
       ...
       <ul class="side-nav-second-level collapse" aria-expanded="false">
          ...
          <li>
             <a href="<?php echo site_url($controller.'/reports/inward'); ?>">Buffalo Inward</a>
          </li>
          <?php } ?>
          
          <?php if(access('pass_outward_report')){ ?>
          <li>
             <a href="<?php echo site_url($controller.'/reports/outward'); ?>">Buffalo Outward</a>
          </li> 
          <?php } ?>
          
          <?php if(access('pandol_info_report')){ ?>
          <li>
             <a href="<?php echo site_url($controller.'/reports/pandol-availability'); ?>">Pando Info</a>
          </li> 
          <?php } ?>
          
          <?php if(access('printid_button')){ ?>
          <li>
             <a href="<?php echo site_url($controller.'/reports/dawanwala'); ?>">Agent (Dawanwala)</a>
          </li> 
          <?php } ?>
          
          <?php if(access('pandol_info_report')){ ?>
          <li>
             <a href="<?php echo site_url($controller.'/reports/hourly-outward'); ?>">Hourly Outward</a>
          </li> 
          <?php } ?>
          
          <?php if(access('pandol_info_report')){ ?>
          <li>
             <a href="<?php echo site_url($controller.'/reports/daily-report'); ?>">Daily Report</a>
          </li> 
          <?php } ?>
