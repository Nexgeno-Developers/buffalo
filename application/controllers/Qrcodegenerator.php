...
class Qrcodegenerator extends CI_Controller {
	...
	public function generate_qrcode($qr_digit, $certificate, $tag) 
	{
        ...
        echo '<img src="'.$qrcode.'" alt="QR Code" width="150px" height="150px"><p style="position:relative;top: -10px;margin-left: 16px;font-size: 12px; margin-top: 2px;"><b>Cert:'.$certificate.'</b></p></div>';
	}
